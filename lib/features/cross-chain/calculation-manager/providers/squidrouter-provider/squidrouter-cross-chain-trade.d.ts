...
export declare class SquidrouterCrossChainTrade extends EvmCrossChainTrade {
    ...
    /** @internal */
    static getGasData(from: PriceTokenAmount<EvmBlockchainName>, to: PriceTokenAmount<EvmBlockchainName>, transactionRequest: (receiverAddress: string) => Promise<SquidrouterTransactionResponse>): Promise<GasData | null>;
