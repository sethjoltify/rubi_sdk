...
export declare class BridgersCrossChainProvider extends CrossChainProvider {
    ...
    protected getFeeInfo(fromBlockchain: BridgersCrossChainSupportedBlockchain, _providerAddress: string, percentFeeToken: PriceTokenAmount, _useProxy: boolean, _contractAbi: AbiItem[]): Promise<FeeInfo>;
}
