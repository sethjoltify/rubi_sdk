    ...
    async calculate(from, toToken, options) {
        ...
        try {
            ...
            const gasData = options.gasCalculation === 'enabled' && options.receiverAddress
                ? await changenow_cross_chain_trade_1.ChangenowCrossChainTrade.getGasData(changenowTrade, options.receiverAddress)
                : null;
            const trade = new changenow_cross_chain_trade_1.ChangenowCrossChainTrade({ ...changenowTrade, gasData }, options.providerAddress);
