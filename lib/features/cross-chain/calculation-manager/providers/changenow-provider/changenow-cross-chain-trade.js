...
class ChangenowCrossChainTrade extends evm_cross_chain_trade_1.EvmCrossChainTrade {
    /** @internal */
    static async getGasData(changenowTrade, receiverAddress) {
        ...
        try {
            const { contractAddress, contractAbi, methodName, methodArguments, value } = await new ChangenowCrossChainTrade(changenowTrade, evm_web3_pure_1.EvmWeb3Pure.EMPTY_ADDRESS).getContractParams({ receiverAddress });
