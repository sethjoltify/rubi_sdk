...
class SyncSwapAbstractTrade extends evm_on_chain_trade_1.EvmOnChainTrade {
    ...
    static async getGasLimit(tradeStruct, dexContractAddress) {
        ...
        try {
            const transactionConfig = await new SyncSwapAbstractTrade(tradeStruct, evm_web3_pure_1.EvmWeb3Pure.EMPTY_ADDRESS, dexContractAddress).encode({ fromAddress: walletAddress });
